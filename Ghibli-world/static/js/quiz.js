document.addEventListener("DOMContentLoaded", () => {
  ...
  const QUESTIONS = [
    { q: "Pick a cozy setting:", opts: [
      ...
      { label: "Lantern-lit river festival", val: "playful" },
    ]},
    ...
    { q: "A sound you love:", opts: [
      ...
      { label: "Giggling tide pools", val: "playful" },
    ]},
    { q: "Choose a treat:", opts: [
      ...
      { label: "Fried sweet potato sticks", val: "playful" },
    ]},
    { q: "What energy do you want to carry this week?", opts: [
      ...
      { label: "Focused and thoughtful", val: "wise" },
    ]},
    { q: "Where do you feel most alive?", opts: [
      { label: "In a workshop lit by sunrise", val: "wise" },
      { label: "Splashing through shallow waves", val: "playful" },
      { label: "Racing the wind on a glider", val: "brave" },
      { label: "Sharing stories around a hearth", val: "kind" },
    ]},
    { q: "Choose a keepsake to tuck away:", opts: [
      { label: "Pressed leaf notebook", val: "calm" },
      { label: "Pocket watch etched with stars", val: "mysterious" },
      { label: "Seashell that sings", val: "playful" },
      { label: "Blueprint folded neatly", val: "wise" },
    ]},
  ];
